...
export const LocationDetailsResponse: MessageFns<LocationDetailsResponse> = {
  encode(message: LocationDetailsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): LocationDetailsResponse {
    return {
      ...
      items: globalThis.Array.isArray(object?.items) ? object.items.map((e: any) => LocationMediaItem.fromJSON(e)) : [],
    };
  },
  ...
  create<I extends Exact<DeepPartial<LocationDetailsResponse>, I>>(base?: I): LocationDetailsResponse {
    return LocationDetailsResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<LocationDetailsResponse>, I>>(object: I): LocationDetailsResponse {
    const message = createBaseLocationDetailsResponse();
