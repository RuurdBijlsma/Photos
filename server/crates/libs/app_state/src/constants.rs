...
// assets folder subfolders
pub const TAG_VOCAB_FOLDER: &str = "assets/tag-vocab";
// static cache folders (in assets)
pub const VOCAB_CACHE_FOLDER: &str = "assets/static-cache/tag-vocab";
